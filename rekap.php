...
// MODIFIKASI: Hanya ambil daftar kelas yang BELUM lulus
...
if ($id_kelas_pilih == '') {
    // MODIFIKASI: Pilih kelas aktif pertama sebagai default
...
<head>
    ...
    <title>Rekap Absensi - <?php echo $sekolah_nama; ?></title>
    ...
    <style>
        ...
        .info-box {
            text-align: center; padding: 15px; border-radius: 8px; color: white;
        ...
        .angka-besar { font-size: 2rem; font-weight: bold; }
    </style>
</head>
<body>
    ...
    <div class="header-sekolah container-fluid">
        <div class="container">
            ...
            <div class="judul-atas">REKAP <?php echo strtoupper($d_set['judul_kegiatan']); ?></div>
        </div>
    </div>
            ...
            <div class="card-body">
                <form method="GET" action="">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            <a href="index.php" class="btn btn-secondary w-100 fw-bold">Kembali ke Scan</a>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            ...
                            if($id_kelas_pilih != '') {
                                ...
                                if (mysqli_num_rows($result) == 0) {
                                    echo "<tr><td colspan='5' class='text-center p-4'>Belum ada data siswa aktif di kelas ini.</td></tr>";
                                }
                                ...
                                while ($data = mysqli_fetch_array($result)) {
                                    ...
                                    elseif ($st == 'Hadir' || $st == 'Manual Admin') {
                                        $ket_html = "<span class='badge-hadir'>$label_hadir ✅</span>";
                                    }
                                    ...
                                    $waktu = ($data['waktu_scan'] && $data['waktu_scan'] != '-') ? $data['waktu_scan'] . " WITA" : "-";
                                    $badge_jk = ($data['jenis_kelamin'] == 'L') ? 'primary' : 'danger';
                                ?>
                                    <tr>
                                        <td><?php echo $no++; ?>.</td>
                                        <td class="fw-bold"><?php echo $data['nama_siswa']; ?></td>
                                        <td><span class="badge bg-<?php echo $badge_jk; ?>"><?php echo $data['jenis_kelamin']; ?></span></td>
                                        <td><?php echo $waktu; ?></td>
                                        <td><?php echo $ket_html; ?></td>
                                    </tr>
                                <?php } 
                            } else {
                                echo "<tr><td colspan='5' class='text-center p-4'>Silakan pilih kelas aktif terlebih dahulu.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
